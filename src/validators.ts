...
function validateMethod(attribute: Attribute): Diagnostic | undefined {
...
function validateRoute(attribute: Attribute): Diagnostic | undefined {
...
function validateHttpCodeHolder(attribute: Attribute): Diagnostic | undefined {
	if (!attribute.value) {
		return new Diagnostic(
			attribute.valueRange!,
...
function validateIdentifierHolder(attribute: Attribute): Diagnostic | undefined {
	if (!attribute.value) {
		return new Diagnostic(
			attribute.valueRange!,
...
export const Validators: { [Key in AttributeNames]?: (attribute: Attribute) => Diagnostic | undefined } = {
